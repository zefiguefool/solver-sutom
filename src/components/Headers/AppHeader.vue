<template>
    <div id="header-top" :class="['header-top', game]">
        <h1 v-html="titreHTML" class="h1 py-2 ps-0 pe-4 text-white"></h1>
        ...
        <div role="presentation" class="intro col-md-7 mx-auto small">
            <h2 class="text-center font-weight-bold font-size-lg">Comment utiliser <span class="title pe-1">Solvami ?</span> 
                <span class="text-dark fs-6 font-weight-bold underline">
                    <a href="#" title="Aller au Solver" @click.prevent="emitScroll" class="anchor maroon" aria-label="Go to Solver">
...
<svg width="8%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
 <path d="M8 12L12 16M12 16L16 12M12 16V8M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <details name="details-infos" class="details-infos">
                ...
                <div class="more-infos-container expendable">
                    <ul class="more-infos text-left font-smaller">
                       ...
                       <li class="third"><i class="em em-abc" aria-role="presentation" aria-label="INPUT SYMBOL FOR LATIN LETTERS"></i> Le dictionnaire se base sur une liste de mots français courants issus du <a href="https://github.com/SergeMalderez/Lexique383_v2" target="_blank" title="Aller sur le site de Lexique383 V2" class="underline color-primary bg-secondary">Lexique383 V2</a>, il est donc possible que certains mots
                        soient manquants. N'hésitez pas à me signaler les mots manquants ou à me proposer des
                        améliorations sur le <a href="https://github.com/zefiguefool/solver-sutom" target="_blank" title="Aller sur le dépôt du projet" class="underline color-primary bg-secondary">dépôt gitHub <svg data-component="Octicon" aria-hidden="true" focusable="false" class="octicon octicon-mark-github" viewBox="0 0 24 24" width="16" height="16" fill="currentColor" display="inline-block" overflow="visible" ><path d="M10.226 17.284c-2.965-.36-5.054-2.493-5.054-5.256 0-1.123.404-2.336 1.078-3.144-.292-.741-.247-2.314.09-2.965.898-.112 2.111.36 2.83 1.01.853-.269 1.752-.404 2.853-.404 1.1 0 1.999.135 2.807.382.696-.629 1.932-1.1 2.83-.988.315.606.36 2.179.067 2.942.72.854 1.101 2 1.101 3.167 0 2.763-2.089 4.852-5.098 5.234.763.494 1.28 1.572 1.28 2.807v2.336c0 .674.561 1.056 1.235.786 4.066-1.55 7.255-5.615 7.255-10.646C23.5 6.188 18.334 1 11.978 1 5.62 1 .5 6.188.5 12.545c0 4.986 3.167 9.12 7.435 10.669.606.225 1.19-.18 1.19-.786V20.63a2.9 2.9 0 0 1-1.078.224c-1.483 0-2.359-.808-2.987-2.313-.247-.607-.517-.966-1.034-1.033-.27-.023-.359-.135-.359-.27 0-.27.45-.471.898-.471.652 0 1.213.404 1.797 1.235.45.651.921.943 1.483.943.561 0 .92-.202 1.437-.719.382-.381.674-.718.944-.943"></path></svg> du projet</a>.</li>
                    </ul>
                    <p class="text-center"><strong>BONNE CHANCE ET AMUSEZ-VOUS BIEN !</strong></p>
                </div>
            </details>
...
export default {
    ...
    methods: {
        soundAction() {
            ...
            setSoundEnabled(this.soundActive);
        },
        emitScroll(){
...
/*         loadThemeCss() {
            ...
            if (this.game === "sutom") {
            link.href = "/css/Header.sutom.css";
            } else if (this.game === "tusmo") {
            link.href = "/css/Header.tusmo.css";
            } else if (this.game === "wordle") {
            link.href = "/css/Header.wordle.css";
            }
         ...
         gameClass() {
            return {
                sutom: this.game === "sutom",
                tusmo: this.game === "tusmo",
                wordle: this.game === "wordle",
            };
        }
    },
/*     mounted() {

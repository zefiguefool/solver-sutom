    ...
    <div id="header-top" class="header-top wordle">
        ...
        <a class="sound-element" @click="soundAction()" href="#">
         ...
         <div class="intro col-md-7 mx-auto">
            ...
            <p class="intro-first-line">Comment utiliser le <a href="#anchor" class="anchor" aria-label="Go to Solver">Solver <span class="font-weight-bold p-0">&darr;</span></a> pour Wordle ?</p>
            <ul>
